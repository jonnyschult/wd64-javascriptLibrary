        ...
        <div className="main">
            <div className="mainDiv">
                ...
                <dl>
                    ...
                    <dd>These are used to construct and updaate the DOM, or what you see on the screen.</dd>
                    <dt>Not Required</dt>
...
const CreateElementComponent = () => {
    return React.createElement('div', {
        ...
        React.createElement('img', {src: "https://pbs.twimg.com/media/DOzL82mXkAA0zFs.jpg"})
    );
}