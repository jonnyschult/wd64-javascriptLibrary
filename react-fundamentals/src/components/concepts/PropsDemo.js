  ...
  return (
    <div className="main">
      <div className="mainDiv">
        <div style={styles}>
          <FunctionialComponent
            string="Toggle Text Color"
            function={toggleColor}
            selectedStyle={color}
          />
          <FunctionialComponent
            string={"Toggle Background Color"}
            function={toggleBackgroundColor}
            selectedStyle={backgroundColor}
          />
          <FunctionialComponent
            string={"Toggle Border Radius"}
            function={toggleBorderRadius}
            selectedStyle={borderRadius}
          />
          <FunctionialComponent
            string={"Toggle BorderStyle"}
...
const FunctionialComponent = (props) => {
  return (
    <div>
      <p>{props.string}</p>
