...
* ***************
    ...
    - Classes act as a blueprint for creating objects. 
        ex: model could be a propert of a class of Automobile. Each new automobile we crea that's a copy of our original class and could have a value for the property model. 
    - Body of a class is between {}
    - Constuctor method is a special method for creating and initializing an object that was created with a class. 
    ...
    - Introduced in ES5
    - New way to write previous existing prtotype-based inheritance. 
    - Closest thing in vanilla JS to OOP (Object Oriented Programing).
*/
...
* ****************
    ...
    - the name given to an unnamed class expression is loval to the class's body. 
        - The name of a named class can be rtreieved throght the class's name property.
*/
...
*/
//ne object/instance of the class
...
!   CONSTRUCTOR METHOD
* ***********
    - Helps create and initialiazed an object created from a class. 
...
let chocolateChip = new Cookie('chocolate chip', false, 'round');
...
let Cat = new Animal('Ronaldo');
Cat.eat();
// Cat.play(); throws error because play(); is not a function in the class Animal 
